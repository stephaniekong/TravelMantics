...
public class InsertActivity extends AppCompatActivity {
    ...
    // Used to create new travel deals
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dealImage = findViewById(R.id.new_deal_image);
        ...
        dealImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                CropImage.activity()
                        ...
                        .start(InsertActivity.this);
            }
        });

        String dealImg = travelDeal.getImageUrl();
        if (dealImg != null && !dealImg.isEmpty()) {
            //Using picasson image library to load images
            Picasso.get()
    ...
    private void saveDeal() {
        ...
        if (travelDeal.getId() != null) {
            ...
            if (imageURI != null) {
                ...
                Toast.makeText(getApplicationContext(), "Select Deal Image to continue", Toast.LENGTH_LONG).show();
                progressDialog.hide();
            }
        }
    }
                ...
                public void onClick(final DialogInterface dialogInterface, int i) {
                    ...
                    picRef.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            ...
                            Toast.makeText(InsertActivity.this, "Deal Deleted!", Toast.LENGTH_SHORT).show();
                            backToTravelListActivity();
                        }
                    }).addOnFailureListener(new OnFailureListener() {
                        @Override
